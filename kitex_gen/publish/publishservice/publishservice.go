...
func getPublishVideosHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(publish.PublishService).GetPublishVideos(ctx, req)
		if err != nil {
			return err
		}
	...
	case *GetPublishVideosArgs:
		success, err := handler.(publish.PublishService).GetPublishVideos(ctx, s.Req)
		if err != nil {
			return err
		}
...
func postVideosHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(publish.PublishService).PostVideos(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *PostVideosArgs:
		success, err := handler.(publish.PublishService).PostVideos(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getVideosHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(publish.PublishService).GetVideos(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetVideosArgs:
		success, err := handler.(publish.PublishService).GetVideos(ctx, s.Req)
		if err != nil {
			return err
		}
...
var GetVideosArgs_Req_DEFAULT *publish.DouyinPublishRequest

func (p *GetVideosArgs) GetReq() *publish.DouyinPublishRequest {
	if !p.IsSetReq() {
...
var GetVideosResult_Success_DEFAULT *publish.DouyinPublishResponse
...
func (p *GetVideosResult) GetSuccess() *publish.DouyinPublishResponse {
	if !p.IsSetSuccess() {
...
func (p *kClient) GetVideos(ctx context.Context, Req *publish.DouyinPublishRequest) (r *publish.DouyinPublishResponse, err error) {
